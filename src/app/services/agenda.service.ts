  ...
  private agenda: AgendaItem[] = [
    {
      id: 1,
      title:
        "Day 1: Conference Delegate Registration (Collection of Delegate Cards)",
      speakerIds: [],
    ...
    },
    {
      id: 4,
      title:
        "Session 1:  Chairperson of Session – Mr Zebra Kasete (President, CoM) Mining in Namibia: Policy & Sector Overview",
      speakerIds: [16],
    ...
    },
    {
      id: 5,
      title:
        "Q & A Session with Minister: Burning Issues on Namibia’s mining sector – local content, ownership, Mining’s contribution to Namibia’s economy ",
      speakerIds: [1],
      startTime: "08/30/2023 14:20 PM",
      endTime: "15:20 PM",
      description: "",
    },
    {
      id: 6,
      title:
        "RMB Panel Discussion - Exploring Investment, Innovation & Sustainable Practice Along the Mining Lifecyle: The Case of Namibia",
    ...
    },
    {
      id: 7,
      title:
        "Nuclear energy in the global energy transition and implications for Namibias uranium sector",
      speakerIds: [11],
    ...
    },
    {
      id: 9,
      title:
        "Session 2: Chairperson of Session – Mr George Botshiwe (1st Vice President, CoM) Critical Minerals projects in Namibia",
      speakerIds: [17],
      startTime: "08/30/2023 17:00 PM",
      endTime: "17:00 PM",
      description: "",
    ...
    },
    {
      id: 18,
      title:
        "Session 3: Chairperson of Session – Mr Veston Malango (CEO, CoM) Value Addition of Critical Minerals in Namibia",
      speakerIds: [],
      startTime: "08/31/2023 10:40 AM",
      endTime: "10:40 AM",
      description: "",
    ...
    },
    {
      id: 20,
      title:
        "The mineral value chains in battery industry – from exploration to beneficiation",
      speakerIds: [4],
    ...
    },
    {
      id: 21,
      title:
        "The Memorandum of Understanding between Namibia and EU: Partnership on Sustainable Raw Materials Value Chains",
      speakerIds: [8],
