describe('segment/test/nav: ios', function() {

it('should init', function() {
  browser.get('http://localhost:8876/dist/e2e/segment/test/nav/index.html?ionicplatform=ios&ionicanimate=false&snapshot=true');
});
