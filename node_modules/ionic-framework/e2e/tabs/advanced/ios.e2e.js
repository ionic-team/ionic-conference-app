describe('tabs/test/advanced: ios', function() {

it('should init', function() {
  browser.get('http://localhost:8876/dist/e2e/tabs/test/advanced/index.html?ionicplatform=ios&ionicanimate=false&snapshot=true');
});
