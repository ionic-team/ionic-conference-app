describe('searchbar/test/floating: android', function() {

it('should init', function() {
  browser.get('http://localhost:8876/dist/e2e/searchbar/test/floating/index.html?ionicplatform=android&ionicanimate=false&snapshot=true');
});
