...
/***/ function(module, exports, __webpack_require__) {
	...
	var ionic_1 = __webpack_require__(4);
	var View1Cmp = (function () {
	    function View1Cmp(location, viewCtrl) {
	        this.path = location.path();
	        this.viewCtrl = viewCtrl;
	        console.log("View1Cmp, path: " + this.path);
	    }
	    View1Cmp.prototype.onPageDidEnter = function () {
	        this.windowHash = window.location.hash;
	    };
	    View1Cmp = __decorate([
	        ionic_1.Page({ templateUrl: 'view1.html' }), 
	        __metadata('design:paramtypes', [(typeof (_a = typeof router_1.Location !== 'undefined' && router_1.Location) === 'function' && _a) || Object, (typeof (_b = typeof ionic_1.ViewController !== 'undefined' && ionic_1.ViewController) === 'function' && _b) || Object])
	    ], View1Cmp);
	    return View1Cmp;
	    var _a, _b;
	})();
	var View2Cmp = (function () {
	    function View2Cmp(location, viewCtrl) {
	        this.path = location.path();
	        this.viewCtrl = viewCtrl;
	        console.log("View2Cmp, path: " + this.path);
	    }
	    View2Cmp.prototype.onPageDidEnter = function () {
	        this.windowHash = window.location.hash;
	    };
	    View2Cmp = __decorate([
	        ionic_1.Page({ templateUrl: 'view2.html' }), 
	        __metadata('design:paramtypes', [(typeof (_a = typeof router_1.Location !== 'undefined' && router_1.Location) === 'function' && _a) || Object, (typeof (_b = typeof ionic_1.ViewController !== 'undefined' && ionic_1.ViewController) === 'function' && _b) || Object])
	    ], View2Cmp);
	    return View2Cmp;
	    var _a, _b;
	})();
	var View3Cmp = (function () {
	    ...
	    View3Cmp.prototype.onPageDidEnter = function () {
	        this.windowHash = window.location.hash;
	    };
	    View3Cmp = __decorate([
	        ionic_1.Page({ templateUrl: 'view3.html' }), 
	        __metadata('design:paramtypes', [(typeof (_a = typeof ionic_1.NavParams !== 'undefined' && ionic_1.NavParams) === 'function' && _a) || Object, (typeof (_b = typeof router_1.Location !== 'undefined' && router_1.Location) === 'function' && _b) || Object, (typeof (_c = typeof ionic_1.ViewController !== 'undefined' && ionic_1.ViewController) === 'function' && _c) || Object])
	    ], View3Cmp);
	    return View3Cmp;
	    var _a, _b, _c;
	})();
	var InboxApp = (function () {
	    function InboxApp(location) {
...
/***/ function(module, exports) {
	...
	module.exports = require("ionic/ionic");
